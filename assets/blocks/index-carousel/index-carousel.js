...
function navScroll(e) {
  ...
  const carousel = btn.closest('.index-carousel');
  const num = carousel.querySelectorAll('.index-carousel-slide').length;
  const slide = carousel.querySelector('.index-carousel-slide');
...
export default async function decorateIndexCarousel(block) {
